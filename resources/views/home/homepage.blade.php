        ...
        <div class="row gy-4">
          <div class="col-md-6">
            ...
            <div class="row justify-content-between gy-4">
              ...
              <div class="col-lg-7 about-info">
                <p><strong>Name: </strong> <span>Okeke Nnaemeka</span></p>
                <p><strong>Profile: </strong> <span>full stack developer</span></p>
                <p><strong>Email: </strong> <span>fidelisokeke2@gmail.com</span></p>
            ...
            <div class="skills-content skills-animation">
              ...
              <div class="progress">
                <span class="skill"><span>Node</span> <i class="val">80%</i></span>
                <div class="progress-bar-wrap">
                  <div class="progress-bar" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
              </div><!-- End Skills Item -->
          ...
          <div class="col-md-6">
            <div class="about-me">
              <h4>About me</h4>
              <p>
                i'm result driven, determined and focused with years of experience under my belt working for companies and working as a freelancer.
              </p>
              <p>
                i have come to learn some very important aspects of programing
                with Skills in JavaScript, PHP, HTML, CSS, and Python, we stand to deliver your projects in record time. 
        ...
        <div class="row">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="resume-item">
              ...
              <h5>2017 - 2021</h5>
              <p><em>Godfrey Okoye University</em></p>
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="resume-item">
              <h4>Database management Support Assistant</h4>
              <h5>2022-2023</h5>
              <p><em>Nigerian Hydrological Services Agency</em></p>
              <ul>
                
                <li>Managed up to 5 projects or tasks at a given time while under pressure</li>
                <li>Recommended and consulted with clients on issues pertaining to aceessing and utilizing the database</li>
        ...
        <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
          ...
          @foreach($post as $post)
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app">
              <img src="/postimage/{{$post->image}}" class="img-fluid" alt="">
              <h4> {{$post->title}}</h4>
              <p>post by<br>Admin</p>
